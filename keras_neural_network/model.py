...
# optimizer: change keras.optimizers.'SGD' for RMSprop or Adam
# loss = 'mean_squared_logarithmic_error', 'huber', 'log_cosh'.
...
print('Minimo msle: ',np.amin(history.history['msle']))
# plt.plot(history.history['msle'])
# val_msle=history.history['val_mse']
# plt.plot(msle)
# plt.plot(val_msle)
